...
from .views import UserAssetsView,TextTo3DModelView,AssetListCreateView,AssetRetrieveView,ImageTo3DModelView,CheckTaskStatusView
...
urlpatterns = [
    ...
    path('check-task-status/<task_id>/', CheckTaskStatusView.as_view(), name='check-task-status'),
